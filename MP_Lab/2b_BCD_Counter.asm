...
code segment
  ...
  next:         
    out dx,al    ;to move 8 bit data to port A and thus display the output through the glowing LEDs
    call delay   ;calls delay procedure
    add al,01   ;increment al's value by 1
    daa         ;decimal adjust after addition Ex: it converts 13 to 01 and 03
